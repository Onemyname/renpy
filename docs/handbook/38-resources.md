...
**Официальная документация:** сам код — `../../tools/vn/src/vn/cli.py` (1930 строк) плюс [Свой движок](25-custom-engine.md).
...
| `../adr/` | 14 решений + шаблон | принятые архитектурные решения с контекстом и последствиями | когда «почему это так?» |
...
Ни один ADR не имеет статуса «заменено». Из 14 ADR тринадцать приняты, один (0008) предложен и ждёт решения владельца.
