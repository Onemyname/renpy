...
> **🧊 Ветка заморожена (ADR-0020, 2026-08-21):** решение о выходе в Steam не
> принято; тулинг остаётся в коде и не удаляется, ревью пропускает зону осознанно.
> Ниже — состояние на момент заморозки.
>
