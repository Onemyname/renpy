...
| Достижения | **IMPLEMENTED** | Бэкенд, экран `achievements` и пункт рельсы есть; нет прогресса отдельной ачивки и уведомления о выдаче. Ни ADR, ни раздела в нормативе — одно упоминание в `ARCHITECTURE.md:2720`; канон — [15](15-gallery.md) |
