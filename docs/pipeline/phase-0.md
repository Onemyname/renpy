...
### 3.4b The Sims 4 — опциональный четвёртый источник (задел)

Задел на будущее (ADR-0007): продакшен-трек проекта — DAZ (+ VaM точечно),
контент на Sims 4 сейчас не производится. Движок источника при этом полностью
готов — если трек решат задействовать, включение не потребует изменений
конвейера.
